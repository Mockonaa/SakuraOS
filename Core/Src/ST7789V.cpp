...
void ST7789V_init_v2(void) {
	...
	ST7789V_enablePower();				// GPIO Init
	ST7789V_enableReset();
	ST7789V_enableExtendedControl();
	HAL_Delay(120);

	FMCSRAMInit(&ST7789VSpec, ST7789V_SRAM_BANK); // FMC Init
	...
	ST7789V_SEND_DATA(0x05);
	ST7789V_SEND_COMMAND(ST7789V_TEON);
	ST7789V_SEND_DATA(0x00);
	ST7789V_SEND_COMMAND(ST7789V_FRCTRL1); //Frame Rate Control set to 40 Hz
	ST7789V_SEND_DATA(0x1E);

	ST7789V_SEND_COMMAND(ST7789V_PVGAMCTRL);
	ST7789V_SEND_DATA(0xA2);
	ST7789V_SEND_DATA(0xA);
	ST7789V_SEND_DATA(0x11);
	ST7789V_SEND_DATA(0xA);
	ST7789V_SEND_DATA(0xC);
	ST7789V_SEND_DATA(0x1A);
	ST7789V_SEND_DATA(0x34);
	ST7789V_SEND_DATA(0x22);
	ST7789V_SEND_DATA(0x4D);
	ST7789V_SEND_DATA(0x28);
	ST7789V_SEND_DATA(0x15);
	ST7789V_SEND_DATA(0x13);
	ST7789V_SEND_DATA(0x29);
	ST7789V_SEND_DATA(0x2D);
